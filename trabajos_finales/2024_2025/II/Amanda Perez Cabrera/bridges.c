...
#define MAX_FARMERS 14 // Aumentar los agricultores de 10 a 14
#define NORTH 0
#define SOUTH 1
#define MAX_CONSECUTIVE 2 // Disminuido de 3 a 2
...
void cross_bridge(int direction, int farmer_id) {
    ...
    sleep(6); // reducido el tiempo a 6
}
...
int main() {
    ...
    // Secuencia especifica de entrada (NORTE=0, SUR=1)
    int order[MAX_FARMERS] = {0, 1, 0, 1, 0, 0, 0, 1, 0, 1, 1, 0, 1, 0};  // Ejemplo ajustado a 14 agricultores
