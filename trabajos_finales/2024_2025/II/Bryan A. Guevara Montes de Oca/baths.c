...
#include <stdbool.h>
#include <stdlib.h>
#define CAPACIDAD 5 // Tamaño de la cola modificado
#define HOMBRE 1
#define MUJER 0
...
void* persona(void* arg) {
    ...
    // Esperar mientras el baño está lleno o es del otro género
...
int main() {
    ...
    bool generos[10] = {0, 0, 1, 1, 0, 1, 0, 1, 1, 1}; // Nuevo orden
