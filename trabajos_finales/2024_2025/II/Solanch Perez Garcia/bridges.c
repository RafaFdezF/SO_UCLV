...
#define MAX_FARMERS 14 // Aumentado la cantidad de agricultores de 10 a 14
#define NORTH 0
#define SOUTH 1
#define MAX_CONSECUTIVE 4  // Aumentado de 3 a 4
...
int main() {
    ...
    int order[MAX_FARMERS] = {0, 1, 1, 0, 1, 0, 0, 1, 0, 1, 0, 1, 0, 1};  // Ejemplo ajustado a 14 agricultores
